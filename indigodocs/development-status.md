...
> Indigo version 0.6.0 was released on the 5th of January 2021, and should be considered to be in an "alpha" state i.e. We believe it's useful, but we expect issues will emerge through use.

> Please note that this documentation site is not yet fully up to date with Scala 3 or Indigo 0.6.0 - we're working on it. Please see the example repos for reference, which are up to date.
